...
#                  undef_method m unless m.to_s =~ /method_missing|respond_to?|^__|^instance_variable|^define_method|^send/
#                  puts "undef_method '#{m.to_s}'" unless m.to_s =~ /method_missing|respond_to?|^__|^instance_variable|^define_method|^send/
                end
              end
